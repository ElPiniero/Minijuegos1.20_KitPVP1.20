...
#execute as @e[tag=Silla,type=interaction] on target run ride @s mount @e[tag=Silla,type=interaction,sort=nearest,limit=1]
#execute as @e[tag=Silla,type=interaction] if data entity @s interaction run data remove entity @s interaction
...
execute as @a[tag=Sicario,tag=!sesion_no_iniciada] at @s run function kitpvp:kits/sicario/escuadrones/siguiendo_escuadron
