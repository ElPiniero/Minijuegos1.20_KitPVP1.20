...
tellraw @a[tag=!sesion_no_iniciada] [{"text": "Iniciando una votacion para activar el subminijuego ","color": "light_purple"},{"text": "SUPERVIVENCIA ZOMBIS","color": "dark_red","bold": true},{"text": ", 10 segundos para terminar","color": "light_purple"}]
...
function kitpvp:cuerpo_del_juego/votos/survival-z/s-z_a_favor
schedule function kitpvp:cuerpo_del_juego/votos/survival-z/conteo_activar 1s