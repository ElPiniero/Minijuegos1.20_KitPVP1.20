execute if entity @s[tag=modo-eliminacion] unless data storage modo_de_pvp {Modo:"eliminacion"} run function kitpvp:cuerpo_del_juego/carteles/modo_de_pvp/eliminacion
execute if entity @s[tag=modo-arena] unless data storage modo_de_pvp {Modo:"arena"} run function kitpvp:cuerpo_del_juego/carteles/modo_de_pvp/arena
