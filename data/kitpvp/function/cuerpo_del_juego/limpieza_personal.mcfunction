...
tag @s remove derrotado
tag @s remove derrotado2
tag @s remove NoEscopetaRecargada
...
tag @s remove survival-facil
tag @s remove tridente_viaje
tag @s remove Elite
tag @s remove survival-dificil
tag @s remove dct
tag @s remove psd
tag @s remove survival-ejecutandose
tag @s remove ZBuff
tag @s remove Cumplido
tag @s remove Efecto
tag @s remove yanosabandono
tag @s remove supervivencia-z
tag @s remove R-Recargar
tag @s remove Recarga
tag @s remove E-Recargar
...
tag @s remove Jugador_Zombi_1
tag @s remove Jugador_Zombi_2
tag @s remove r-meatinaron
tag @s remove e-meatinaron
tag @s remove m-meatinaron
tag @s remove Congelador
tag @s remove Escuadrones
tag @s remove ya_me_atacaron
tag @s remove Esperando_Resucitacion
tag @s remove Jugador_Vivo
tag @s remove alto-meatinaron
tag @s remove cuerno_activado
tag @s remove entregar_diamante
tag @s remove Unido_a_Sicario
tag @s remove en_votacion
tag @s remove espectador
tag @s remove lg_austeridad
tag @s remove derrotado
function kitpvp:kits/remover_tag
tag @s remove yamero-survival-z
tag @s remove medio-meatinaron
tag @s remove bajo-meatinaron
tag @s remove yasemurio
tag @s remove Escopeta
tag @s remove Rifle
...
tag @s remove supervivencia-z
team leave @s
scoreboard players reset @s ZombieBuff
scoreboard players reset @s Disparo-Rifle
scoreboard players reset @s Disparo-Escopeta
...
scoreboard players reset @s Conteo_Torretas
scoreboard players reset @s Shield
scoreboard players reset @s Conteo_Racha
...
scoreboard players reset @s Baja_Diamante
...
scoreboard players reset @s Pegar
scoreboard players reset @s Proyectil_4
scoreboard players reset @s Muerte_por_Escuadron
scoreboard players reset @s Proyectil_5
scoreboard players reset @s Baya
scoreboard players reset @s Proyectil_6
scoreboard players reset @s Chorus
scoreboard players reset @s GDS
...
scoreboard players reset @s Disparo-Rifle
scoreboard players reset @s Disparo-Escopeta
scoreboard players reset @s Musica
scoreboard players reset @s ZombieBuff
scoreboard players reset @s ZombieShop
...
scoreboard players reset @s Recarga_Kit
scoreboard players reset @s Sandia
scoreboard players reset @s ManzanaEncantada
scoreboard players reset @s Racha
scoreboard players reset @s Totems
scoreboard players reset @s Flecha
scoreboard players reset @s Bebida_Mandarina
scoreboard players reset @s Bebida_Fresa
scoreboard players reset @s Bebida_Durazno
scoreboard players reset @s Congelante
scoreboard players reset @s Poseyendose
scoreboard players reset @s Golem
scoreboard players reset @s INESoldado
scoreboard players reset @s Recargar
scoreboard players reset @s Alcance-Bala
scoreboard players reset @s Carta
scoreboard players reset @s Vida
scoreboard players reset @s HP
scoreboard players reset @s Salto
scoreboard players reset @s Escopeta-cooldown
scoreboard players reset @s Desactivando
scoreboard players reset @s Rastreador
scoreboard players reset @s Conteo
scoreboard players reset @s Zombis
scoreboard players reset @s Tiempo
scoreboard players reset @s Operacion
scoreboard players reset @s ZombisInactivos
scoreboard players reset @s Z-S_EnContra