...
execute at @n[tag=m-oleada-origen,type=interaction] run summon interaction ~ ~ ~ {Tags:["Vector_oleada","nuevo2"]}
execute at @n[tag=m-oleada-origen,type=interaction] run summon endermite ~ ~ ~ {Tags:["Guia_oleada","nuevo2"],Silent:1b,PersistenceRequired:1b}
execute at @n[tag=m-oleada-origen,type=interaction] run summon zombie_villager ~ ~ ~ {Team:"Zombis",PersistenceRequired:1b,Health:550f,Tags:["jefes","jefes_guia","nuevo2","lider-ola"],HandItems:[{id:"netherite_sword",components:{"minecraft:enchantments":{sharpness:10}},count:1},{id:"netherite_sword",components:{"minecraft:enchantments":{sharpness:10}},count:1}],ArmorItems:[{id:"netherite_boots",components:{"minecraft:enchantments":{protection:4,thorns:4}},count:1},{id:"netherite_leggings",components:{"minecraft:enchantments":{protection:4,thorns:4}},count:1},{id:"netherite_chestplate",components:{"minecraft:enchantments":{protection:4,thorns:4}},count:1},{}],HandDropChances:[0f,0f],ArmorDropChances:[0f,0f,0f,0f],attributes:[{id:"minecraft:follow_range",base:500},{id:"minecraft:max_health",base:550},{id:"minecraft:movement_speed",base:0.6}]}

effect give @n[type=endermite,tag=Guia_oleada,tag=nuevo2] resistance infinite 4 true
effect give @n[type=endermite,tag=Guia_oleada,tag=nuevo2] weakness infinite 4 true
effect give @n[type=endermite,tag=Guia_oleada,tag=nuevo2] invisibility infinite 0 true
ride @n[type=endermite,tag=Guia_oleada,tag=nuevo2] mount @n[type=interaction,tag=Vector_oleada,tag=nuevo2]
ride @n[type=interaction,tag=Vector_oleada,tag=nuevo2] mount @n[type=zombie_villager,tag=lider-ola,tag=nuevo2]
