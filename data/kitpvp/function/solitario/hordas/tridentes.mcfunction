execute if data storage supervivencia-zombis {Horda:"2"} run damage @s 12 trident by @n[type=drowned] from @n[type=drowned]
execute if data storage supervivencia-zombis {Horda:"3"} run damage @s 14 trident by @n[type=drowned] from @n[type=drowned]
execute if data storage supervivencia-zombis {Horda:"4"} run damage @s 20 trident by @n[type=drowned] from @n[type=drowned]
execute if data storage supervivencia-zombis {Horda:"5"} run damage @s 34 trident by @n[type=drowned] from @n[type=drowned]
