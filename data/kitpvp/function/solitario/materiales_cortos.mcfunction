...
execute as @a[tag=!sesion_no_iniciada,tag=Poseidon,nbt=!{OnGround:1b}] at @s if data storage supervivencia-zombis {Horda:"5"} run tp @e[type=#zombies,limit=3,sort=nearest] @s
execute as @a[tag=!sesion_no_iniciada,tag=Quetzal,nbt=!{OnGround:1b}] at @s if data storage supervivencia-zombis {Horda:"5"} run tp @e[type=#zombies,limit=3,sort=nearest] @s
execute as @a[tag=!sesion_no_iniciada,tag=Militar,nbt=!{OnGround:1b}] at @s if data storage supervivencia-zombis {Horda:"5"} run tp @e[type=#zombies,limit=3,sort=nearest] @s
execute as @a[tag=!sesion_no_iniciada,tag=Tecnico,nbt=!{OnGround:1b}] at @s if data storage supervivencia-zombis {Horda:"5"} run tp @e[type=#zombies,limit=3,sort=nearest] @s
