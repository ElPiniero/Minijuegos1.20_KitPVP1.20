...
execute as @e[type=#zombies,nbt=!{FallFlying:1b}] at @s run function kitpvp:solitario/hordas/oleada/reactivacion_zombis
execute as @n[type=#zombies,tag=sin-target,sort=random] at @s run function kitpvp:solitario/hordas/oleada/reactivar_zombis
