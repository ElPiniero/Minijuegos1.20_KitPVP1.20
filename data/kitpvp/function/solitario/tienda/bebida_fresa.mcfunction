...
execute if score @s ZombieShop matches 6.. run give @s potion[max_stack_size=3,custom_name='[{"text":"Bebida de Fresa","italic":false,"color":"#ff0011"}]',potion_contents={custom_color:16711697,custom_effects:[{id:"minecraft:haste",duration:400,amplifier:127,show_particles:1b},{id:"minecraft:strength",duration:400,amplifier:25,show_particles:1b}]}]
