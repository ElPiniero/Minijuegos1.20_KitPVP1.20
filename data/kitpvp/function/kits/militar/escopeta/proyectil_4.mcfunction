...
scoreboard players add @s Proyectil_4 1
execute positioned ^ ^ ^.5 unless score @s Proyectil_4 matches 50.. if block ~ ~ ~ #kitpvp:pasables run function kitpvp:kits/militar/escopeta/proyectil_4
