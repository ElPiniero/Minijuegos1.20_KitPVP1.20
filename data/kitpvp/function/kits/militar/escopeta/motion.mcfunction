...
execute store result storage flecha Datos.mx double 0.004 run scoreboard players operation #motion_x_2 Conteo -= #motion_x_1 Conteo
execute store result storage flecha Datos.my double 0.004 run scoreboard players operation #motion_y_2 Conteo -= #motion_y_1 Conteo
execute store result storage flecha Datos.mz double 0.004 run scoreboard players operation #motion_z_2 Conteo -= #motion_z_1 Conteo
