...
execute as @e[type=!#kitpvp:inmunes,distance=..2.2,tag=!Zorro] at @s anchored eyes facing entity @n[type=item_display,tag=BayaPicosa,tag=yachoco,distance=1..2.2] eyes run tp @s ^ ^ ^.5 ~ 0 
