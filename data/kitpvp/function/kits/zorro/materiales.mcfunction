...
execute if score @s Totem matches 1.. run effect give @s speed infinite 1 true
...
execute if score @s Pegar matches 1.. run effect give @s strength infinite 0 true
