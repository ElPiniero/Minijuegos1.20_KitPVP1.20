...
execute at @e[tag=Maldicion,type=#zombies] run playsound entity.elder_guardian.curse master @a[tag=!sesion_no_iniciada] ~ ~ ~ .5
execute at @e[tag=Maldicion,type=#zombies] run particle campfire_signal_smoke ~ ~1 ~ .1 .1 .1 0.1 50 normal
...
effect give @e[tag=Maldicion,type=#zombies] instant_health 100 2
effect give @e[tag=Maldicion,type=#zombies] wither 30 4
effect give @e[tag=Maldicion,type=#zombies] weakness 60 3
effect give @e[tag=Maldicion,type=#zombies] slowness 60 3
