...
execute if score @s Totem matches 1 run effect give @s invisibility infinite 0 true
execute if score @s Totem matches 1 run effect give @s speed infinite 0 true
