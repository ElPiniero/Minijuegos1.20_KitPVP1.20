...
execute if entity @s[nbt={SelectedItem:{id:"minecraft:bow"}},nbt={Inventory:[{Slot:-106b,id:"minecraft:cake"}]}] positioned ^ ^1.5 ^.5 unless entity @e[type=block_display,tag=Pastel,tag=sin_disparar,distance=..3] run function kitpvp:kits/neon/pastel/activacion
...
execute if score @s Totem matches 1 run effect give @s resistance infinite 1 true
