...
execute if score @s Totem matches 1 run effect give @s[tag=!supervivencia-z] resistance infinite 0 true
execute if score @s Totem matches 1 run effect give @s[tag=supervivencia-z] resistance infinite 1 true
